...
save(fullfile(dataDir, 'quadrotor_strategy_circle_comparison_results.mat'), ...
    'comparison', 'metrics', 'weights');
writetable(metrics, fullfile(dataDir, 'quadrotor_strategy_circle_comparison_metrics.csv'));
write_strategy_metrics_markdown(metrics, fullfile(dataDir, 'quadrotor_strategy_circle_comparison_metrics.md'));
...
fprintf('Strategy comparison finished. Metrics: %s\n', ...
    fullfile(dataDir, 'quadrotor_strategy_circle_comparison_metrics.csv'));
end
