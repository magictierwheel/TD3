...
RL_DIR = ROOT / "results" / "policies" / "rl_v1"
...
def write_docx(rows):
    ...
    add_para(doc, "训练脚本使用交叉熵直接策略搜索，按圆周轨迹误差、终端误差、姿态稳定和动作变化选择权重；结果保存为 results/policies/rl_v1/quadrotor_rl_policy.mat。")
    ...
    doc.save(REPORT_DIR / "强化学习圆周抗扰控制对比报告.docx")
...
def main():
    ...
    print(REPORT_DIR / "强化学习圆周抗扰控制对比报告.docx")
