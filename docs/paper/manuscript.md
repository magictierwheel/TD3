> [!WARNING]
> **LEGACY DRAFT.** 本文对应已废弃的 oracle 扰动观测、PID-FF imitation 和 gate-min 路线。它不是当前投稿稿；旧数字只能作为失败诊断。新方向见 [docs/projects/pybullet_td3/research_plan.md](../projects/pybullet_td3/research_plan.md)。
