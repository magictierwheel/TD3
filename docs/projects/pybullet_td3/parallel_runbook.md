...
This runbook controls execution and recovery. Scientific requirements remain defined by `research_plan.md`, `.research/design_brief.md`, and the rebuild implementation plan. The frozen machine-readable contract is `experiments/circular_tracking/config/hidden_td3_protocol.json`.
...
experiments/circular_tracking/pybullet_td3/studies/pid_residual_td3/stages/10_bootstrap_preflight/evidence/decision.json
global summaries
