...
3. 读 `docs/projects/pybullet_td3/implementation_plan.md`。
4. 检查 `experiments/circular_tracking/pybullet_td3/studies/pid_residual_td3/stages/10_bootstrap_preflight/evidence/decision.json`，确认当前阶段。
