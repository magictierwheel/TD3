...
**Files:**
- Create: `experiments/circular_tracking/pybullet_td3/studies/pid_residual_td3/stages/10_bootstrap_preflight/evidence/decision.json`
...
```powershell
git add experiments/circular_tracking/pybullet_td3/studies/pid_residual_td3/stages/**/evidence experiments/circular_tracking/pybullet_td3/studies/pid_residual_td3/stages/**/config/stage.json
