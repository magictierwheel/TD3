...
def write_markdown(rows):
    ...
    lines = [
        ...
        "## 5. 图表文件",
        "",
        "- `evidence/10_controller_comparison/figures/strategy_circle_trajectory_3d.png`：三类环境下四种控制器三维轨迹。",
        "- `evidence/10_controller_comparison/figures/strategy_circle_position_error.png`：位置误差时序。",
        "- `evidence/10_controller_comparison/figures/strategy_circle_metric_bars.png`：全程 RMS、稳定段 RMS、终端误差柱状图。",
...
def write_docx(rows):
    ...
    doc.save(EXPORT_DIR / "多控制策略圆周抗扰对比报告.docx")
...
def main():
    ...
    print(EXPORT_DIR / "多控制策略圆周抗扰对比报告.docx")
