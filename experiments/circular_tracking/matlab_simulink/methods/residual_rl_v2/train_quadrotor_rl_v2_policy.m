...
rlDir = fullfile(rootDir, 'artifacts', '30_rl_v2_mpc_imitation', 'policy');
dataDir = fullfile(rootDir, 'artifacts', '30_rl_v2_mpc_imitation', 'data');
if ~exist(rlDir, 'dir'), mkdir(rlDir); end
if ~exist(dataDir, 'dir'), mkdir(dataDir); end
addpath(fullfile(rootDir, 'common'));
addpath(fullfile(rootDir, 'methods', 'pid'));
addpath(fullfile(rootDir, 'methods', 'residual_rl_v2'));
addpath(fullfile(rootDir, 'methods', 'residual_rl_v1'));
...
summaryPath = fullfile(rootDir, 'artifacts', '30_rl_v2_mpc_imitation', 'policy', ...
    'quadrotor_rl_v2_policy_summary.md');
