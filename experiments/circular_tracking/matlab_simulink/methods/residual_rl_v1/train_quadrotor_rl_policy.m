...
rlDir = fullfile(rootDir, 'artifacts', '20_residual_rl_v1', 'policy');
dataDir = fullfile(rootDir, 'artifacts', '20_residual_rl_v1', 'data');
...
summaryPath = fullfile(rootDir, 'artifacts', '20_residual_rl_v1', 'policy', ...
    'quadrotor_rl_policy_summary.md');
