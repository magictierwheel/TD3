...
from experiments.circular_tracking.pybullet_td3.studies.pid_residual_td3.study_paths import (
    ENVIRONMENT_SOURCE_PATH as _ENVIRONMENT_SOURCE_PATH,
    FROZEN_PID_PATH as _PID_CONFIG_PATH,
    PROTOCOL_PATH as _PROTOCOL_PATH,
...
def _rollout_identity(controller: str, model_path: Path | None) -> dict[str, object]:
    ...
    return {
        ...
        "protocol_path": str(_PROTOCOL_PATH.relative_to(_REPO_ROOT)).replace("\\", "/"),
