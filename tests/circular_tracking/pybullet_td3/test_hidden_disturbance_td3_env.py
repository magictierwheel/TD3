...
import experiments.circular_tracking.pybullet_td3.studies.pid_residual_td3.code.environments.disturbance_processes as disturbance_processes_module
import experiments.circular_tracking.pybullet_td3.studies.pid_residual_td3.code.environments.hidden_disturbance_td3_env as hidden_env_module
from experiments.circular_tracking.pybullet_td3.studies.pid_residual_td3.code.environments.disturbance_processes import (
...
def test_active_environment_package_exports_only_hidden_environment() -> None:
    import experiments.circular_tracking.pybullet_td3.studies.pid_residual_td3.code.environments as environments

    assert environments.HiddenDisturbanceCircularTD3Env is HiddenDisturbanceCircularTD3Env
    assert environments.__all__ == ["HiddenDisturbanceCircularTD3Env"]
